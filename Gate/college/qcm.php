<?php include('haut.php'); ?>
	...
	<div id="corps">
		...
		<form method="post" action="traitement1.php">
			<p>
				<h5 class=question>La crise économique de 1929 touche seulement en 1931 la France et moins profondément qu’à l’étranger, mais elle dure plus longtemps qu’à l’étranger jusqu’en 1938</h5>
			...
			<p>
				<h5 class=question>La crise économique accentue la crise sociale, comment (4 cases à cocher) ?</h5>
			...
			<p>
				<h5 class=question>La montée du chômage accentue l’hostilité à l’égard des étrangers (=xénophobie)</h5>
			...
			<p>
				<h5 class=question>Les nombreux gouvernements (instabilité gouvernementale) se montrent incapables avant 1936 de résoudre la crise économique : cela entraîne un mécontentement de l’opinion publique</h5>
			...
			<p>
				<h5 class=question>L’instabilité gouvernementale (nombreux gouvernements se succédant à un rythme rapide) est due aux fréquents renversements du gouvernement par le Parlement</h5>
			...
			<p>
				<h5 class=question>Que sont les ligues ?</h5>
			...
			<p>
				<h5 class=question>Que dénoncent les ligues et l’Action française (groupe royaliste) (4 cases à cocher) ?</h5>
			...
			<p>
				<h5 class=question>L’affaire Stavisky qui est un escroc qui a été protégé par des politiciens déclenche en 1934 une violente campagne antiparlementaire qui débouche sur une manifestation des ligues et de l’Action française à Paris le 12 février 1934</h5>
			...
			<p>
				<h5 class=question>Durant la manifestation du 6 février 1934, certains manifestants tentent d’atteindre l’Assemblée nationale pour s’en emparer. La police intervient. Il y a 15 morts et 1500 blessés</h5>
			...
			<p>
				<h5 class=question>Comment est perçue la manifestation du 6 février 1934 par les partis de gauche (socialistes, communistes et radicaux) ?</h5>
			...
			<p>
				<h5 class=question>Quelle est la conséquence de la manifestation du 6 février 1934 pour la gauche ?</h5>
			...
			<p>
				<h5 class=question>Quel est le slogan do programme électoral commun du Front populaire ?</h5>
			...
			<p>
				<h5 class=question>Qui gagne les élections législatives en mai 1936 ?</h5>
			...
			<p>
				<h5 class=question>Qui  devient chef du gouvernement (= Président du conseil) en juin 1936 suite à la victoire du Front populaire ?</h5>
				<input type="radio" name="réponseQ14" value="r1" id="r141" /> <label for="r141">Léon Blum, un socialiste car le parti socialiste est le parti du Front populaire qui a eu le plus de voix aux élections législatives.</label><br/>
			...
			<p>
				<h5 class=question>Les communistes décident de soutenir le gouvernement mais refusent d’en faire parti.</h5>
			...
			<p>
				<h5 class=question>Les radicaux décident de soutenir le gouvernement mais refusent d’en faire parti.</h5>
			...
			<p>
				<h5 class=question>Pour la première fois en France, trois femmes font partie du gouvernement en juin 1936.</h5>
			...
			<p>
				<h5 class=question>Que passe-t-il dans les entreprises suite à la victoire du Front populaire aux élections législatives de 1936 et à leur arrivée au pouvoir en juin 1936 ?</h5>
			...
			<p>
				<h5 class=question>Qui réunit le gouvernement Blum à Matignon pour négocier les accords de Matignon pour mettre fin aux grèves ? (Deux réponses)</h5>
			...
			<p>
				<h5 class=question>Que prévoient les accords de Matignon signés le 7 juin 1936 ? (Trois réponses)</h5>
			...
			<p>
				<h5 class=question>Quelles sont les deux autres grandes lois sociales qui complètent les accords de Matignon ? (Deux réponses)</h5>
			...
			<p>
				<h5 class=question>Quelles sont les difficultés que rencontre le Front populaire ? (Deux réponses)</h5>
			...
			<p>
				<h5 class=question>L’incapacité du Front populaire à résoudre la crise économique entraîne la disparition du Front populaire en avril…</h5>
